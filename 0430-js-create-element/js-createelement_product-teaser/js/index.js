...
<button type="button" class="product__buy-button" data-js="newButton">Buy</button>
</footer>`;

document.body.append(newArticle);

const newButton = document.querySelector('[data-js="newButton"]');

newButton.addEventListener("click", () => {
  console.log(`I am a ${nameFish}! Price: ${price}`);
});
